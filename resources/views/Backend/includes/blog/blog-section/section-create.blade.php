                ...
                <div class="col-sm-offset-2 col-md-8" style="padding-top: 99px;">
                    ...
                    <div class="panel">
                        <div class="panel-header">
                            <h2 class="text-center" style="background-color: #9f191f; color: white;"> Create Blog Section</h2>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <!-- /.box-header -->
                            <div class="">
                                <form role="form" action="{{ route('blog-section.store') }}" method="post" >
                                @csrf
                                ...
                                <!-- text input -->
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-block btn-success">Create Section</button>
                                    </div>
